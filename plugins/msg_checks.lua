...
if msg.caption then 
local link_caption = msg.caption:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.caption:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]/") or msg.caption:match("[Tt].[Mm][Ee]/") or msg.caption:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") or msg.text:match("[Tt][Ee][Ll][e[Ss][Cc][Oo].[Pp][Ee]//") 
if link_caption 
...
local link_msg = msg.text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]/") or msg.text:match("[Tt].[Mm][Ee]/") or msg.text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") or msg.text:match("[Tt][Ee][Ll][e[Ss][Cc][Oo].[Pp][Ee]//") 
if link_msg 
and lock_link == "yes" then 
 if is_channel then 
 del_msg(chat, tonumber(msg.id)) 
...
return 
   ...
   del_msg(chat, msg.id) 
    kick_user(user, chat) 
   del_msg(chat, msg.id) 
send_msg(chat, "`👨┊العضو :` "..user_name.."`"..user.." }`\n ♻┊تم عمل تكرار في المجموعه وتم طرده", nil, "md") 
